...
FAKE_CUSTOMER_BEFORE_TAX_ID = load_fixture("customer_cus_IvVnXlYiO1LL26_before_tax_id.json")
FAKE_CUSTOMER_WITH_TAX_ID = load_fixture("customer_cus_IvVnXlYiO1LL26_with_tax_id.json")
FAKE_CUSTOMER_WITHOUT_TAX_ID = load_fixture("customer_cus_IvVnXlYiO1is25_without_tax_id.json")
FAKE_INVOICEITEM = {
